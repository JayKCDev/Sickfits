...
export const products = [
  {
    productName: "Yeti Hondo",
    productDescription: "soo nice",
  ...
  {
    productName: "Airmax 270",
    productDescription: "Great shoes!",
    productStatus: "AVAILABLE",
    productPrice: 5234,
    productPhoto: {
  ...
  {
    productName: "KITH Hoodie",
    productDescription: "Love this hoodie",
    productStatus: "AVAILABLE",
    productPrice: 23562,
    productPhoto: {
  ...
  {
    productName: "Fanorak",
    productDescription: "Super hip. Comes in a number of colours",
    productStatus: "AVAILABLE",
    productPrice: 252342,
    productPhoto: {
  ...
  {
    productName: "Nike Vapormax",
    productDescription: "Kind of squeaky on some floors",
    productStatus: "AVAILABLE",
    productPrice: 83456,
    productPhoto: {
  ...
  },
  {
    ...
    productDescription: "Who spends this much on a cooler?!",
    productStatus: "AVAILABLE",
    productPrice: 75654,
    productPhoto: {
  ...
  {
    productName: "Naked and Famous Denim",
    productDescription: "Japanese Denim, made in Canada",
    productStatus: "AVAILABLE",
    productPrice: 10924,
    productPhoto: {
  ...
  {
    productName: "Rimowa Luggage",
    productDescription: "S T E A L T H",
    productStatus: "AVAILABLE",
    productPrice: 47734,
    productPhoto: {
  ...
  {
    productName: "Nudie Belt",
    productDescription: "Sick design",
    productStatus: "AVAILABLE",
    productPrice: 5234,
    productPhoto: {
  ...
  },
  {
    ...
    productDescription: "blacked out",
    productStatus: "AVAILABLE",
    productPrice: 6344,
    productPhoto: {
